...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var firebase_admin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! firebase-admin */ \"firebase-admin\");\n/* harmony import */ var firebase_admin__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(firebase_admin__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../database */ \"./src/database.ts\");\nfunction _objectEntries(obj) {\n  var entries = [];\n  var keys = Object.keys(obj);\n\n  for (var k = 0; k < keys.length; k++) entries.push([keys[k], obj[keys[k]]]);\n\n  return entries;\n}\n\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\nfunction migrate(_x, _x2) {\n  return _migrate.apply(this, arguments);\n}\n\nfunction _migrate() {\n  _migrate = _asyncToGenerator(function* (request, response) {\n    // 1. Get all transcript ids\n    console.log(\"transcripts\");\n    const transcripts = yield _database__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getTranscripts(); // 2. For each transcript, rename document fields\n\n    for (const [transcriptId, transcript] of _objectEntries(transcripts)) {\n      console.log(\"FØR trans\", transcript, transcriptId);\n      const status = transcript.process || undefined;\n\n      if (status !== undefined) {\n        status.progress = status.step || \"DONE\";\n        status.step = firebase_admin__WEBPACK_IMPORTED_MODULE_0___default.a.firestore.FieldValue.delete();\n        transcript.status = status;\n        transcript.process = firebase_admin__WEBPACK_IMPORTED_MODULE_0___default.a.firestore.FieldValue.delete();\n        yield _database__WEBPACK_IMPORTED_MODULE_1__[\"default\"].updateTranscript(transcriptId, transcript);\n        console.log(\"oppdaterte\", transcriptId, transcript);\n      } // 3. Rename results and fields\n\n\n      const results = yield _database__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getResults(transcriptId);\n\n      for (const [resultId, result] of _objectEntries(results)) {\n        result.words = result.words.map(word => {\n          return {\n            confidence: word.confidence || 1,\n            endTime: word.endTime,\n            startTime: word.startTime,\n            text: word.word\n          };\n        });\n        yield _database__WEBPACK_IMPORTED_MODULE_1__[\"default\"].setParagraph(transcriptId, resultId, result);\n        console.log(\"Satte paragrah\", resultId, result);\n      }\n    }\n\n    response.sendStatus(200);\n  });\n  return _migrate.apply(this, arguments);\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (migrate);\n\n//# sourceURL=webpack:///./src/migrate/index.ts?");
